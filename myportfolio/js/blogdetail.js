document.addEventListener('DOMContentLoaded', () => {
    ...
    const posts = {
        '1': {
            ...
            content: `
               <p class="mb-4">Join Wintech Cambodia for an immersive 7-day training program designed to transform you into a proficient full-stack web developer. This hands-on course focuses on building a modern web application, such as a website or e-commerce platform, using PHP, JavaScript, React, Laravel, and Figma for UX/UI design. Guided by our expert trainers, you’ll work through a structured curriculum culminating in a live demo.</p>
                <h2 class="font-orbitron text-primary text-lg mb-3">Program Overview</h2>
                <p class="mb-4">This intensive training equips you with practical skills in full-stack development, leveraging Wintech Cambodia’s expertise in creating innovative solutions like system POS and website  . Each day builds on the previous, guiding you from planning to deployment.</p>
                <ul class="list-disc pl-5 mb-4">
                    ...
                    <li><strong>Day 3: Design Planning with PHP, JavaScript, boostrap, Laravel</strong>: Define the project’s architecture, focusing on Laravel for backend and boostrap for frontend.</li>
                    <li><strong>Day 4: Coding Frontend & Backend</strong>: Start coding the frontend with boostrap and backend with Laravel and PHP.</li>
                ...
                <p class="mb-4"><strong>Day 7: Demo Day</strong><br>Deploy the application using Docker for consistency. Present the completed website to instructors and peers at Wintech Cambodia. Showcase features like news browsing, user authentication, and responsive design. Receive feedback and certificates of completion.</p>
                ...
                <p class="mb-4">Wintech Cambodia combines industry expertise with hands-on training, empowering you to build real-world applications. Our trainers, experienced in developing solutions like the system ,website,app, guide you through modern tools and best practices. Whether you’re a beginner or advancing your skills, this program prepares you for a tech career.</p>
            ...
            content: `
               <p class="mb-4">Join Ly Kun Media in Phnom Penh, Cambodia, for an intensive 7-day training program designed to equip you with essential skills in UI/UX design and frontend development. This hands-on course guides you through creating user-centric interfaces and building dynamic web applications, inspired by projects like the website, using tools like Figma, Adobe XD, HTML, CSS, JavaScript, React, and Vite.</p>
                ...
                <ul class="list-disc pl-5 mb-4">
                    ...
                    <li><strong>Day 3: Project Design with Figma</strong>: Design UI/UX wireframes and posters for a website using Figma.</li>
                    ...
                    <li><strong>Day 5: Start with HTML, CSS, JS, React, and Vite</strong>: Build a responsive frontend to know about  it  clearly .</li>
                ...
                <p class="mb-4"><strong>Day 3: Project Design with Figma</strong><br>Start designing a website project, creating wireframes, mockups, and promotional posters in Figma. Focus on user flows, responsive layouts, and visual hierarchy to ensure an engaging UI/UX. Receive </p>
                ...
                <p class="mb-4"><strong>Day 5: Coding with HTML, CSS, JS, React, and Vite</strong><br>Begin coding the frontend . Use HTML and CSS (with Tailwind CSS for rapid styling), JavaScript for interactivity, and React to create reusable components. Set up the project with Vite for optimized development and build a responsive interface for website browsing and user interaction.</p>
        ...
        '3': {
            ...
            <p class="mb-4">Join First Cambodia for an intensive 7-day training program in Phnom Penh, designed to master C# and ASP.NET Core for building robust web applications with database integration. This hands-on course guides you through developing a project, such as a system for bank, culminating in a live demo, leveraging First Cambodia’s expertise in IT solutions.</p>
                ...
                <h2 class="font-orbitron text-primary text-lg mb-3">Daily Breakdown</h2>
                <p class="mb-4"><strong>Day 1: Introduction to First Cambodia</strong><br>Discover First Cambodia’s role as a leading IT solutions provider in Cambodia, delivering projects like cloud solutions and custom software. Learn how C# and ASP.NET power their innovative applications, such as the system for banks. Engage in a Q&A with instructors to understand the training goals and industry expectations.</p>
                ...
                <p class="mb-4"><strong>Day 3: Database Fundamentals</strong><br>Learn database concepts, including relational database design and SQL Server integration with ASP.NET Core. Explore Entity Framework Core for data access, creating models and performing CRUD operations. Design a database schema for a form to store articles and user data.</p>[](https://www.skillsoft.com/course/aspnet-mvc-web-applications-databases-entity-framework-0d78d2d9-a91c-11e7-b050-7a420a93a8e4)[](https://www.h2kinfosys.com/courses/dotnet-online-training-course-details/)
                <p class="mb-4"><strong>Day 4: Team Project with C# and Database</strong><br>Form teams to build a web application  using C# and ASP.NET Core. Implement backend logic with controllers and Entity Framework, connecting to a SQL Server database. Develop a frontend with Razor views and Bootstrap for responsive design. Collaborate to define project features like news browsing and user authentication.</p>[](https://learn.microsoft.com/en-us/visualstudio/get-started/csharp/tutorial-aspnet-core?view=vs-2022)[](https://www.aspdotnet-suresh.com/2015/09/aspnet-mvc-example-demo-project-application-with-database-download.html)
                ...
                <p class="mb-4"><strong>Day 7: Project Demo</strong><br>Deploy the application to a local or cloud environment  and present it to instructors and peers at First Cambodia. , user login, and responsive design. Receive feedback, discuss improvements, .</p>[]
                <div class="flex flex-col sm:flex-row gap-4 mb-4">
                ...
                <p class="mb-4">First Cambodia is a trusted IT leader in Cambodia, offering cutting-edge solutions and professional training in Microsoft technologies. Our instructors bring real-world experience, ensuring you gain practical skills for projects like the system . This program is ideal for beginners and developers looking to advance their careers.</p>[](https://www.h2kinfosys.com/courses/dotnet-online-training-course-details/)
         ...
         '4': {
            ...
            content: `
               <p class="mb-4">Join Chief (Cambodia) Commercial Bank Plc. in Phnom Penh for a 5-day practical training program designed to enhance your skills in software development for banking applications. This intensive course covers the project lifecycle, code security, and the waterfall model, culminating in a quiz to solidify your learning. Tailored for aspiring IT professionals, this training leverages Chief Cambodia’s expertise in financial technology.</p>
                ...
                <p class="mb-4"><strong>Day 3: Code Security</strong><br>Learn best practices for securing code in financial applications, including input validation, encryption, and protection against vulnerabilities like SQL injection and XSS. Study secure coding standards and analyze real-world examples using languages like C# or Python, relevant to banking systems.</p>
          ...
          '5': {
            ...
            date: "October 5, 2022",
            content: `
              <p class="mb-4">Join Beltei International School in Cambodia for a 5-day training program designed to teach students essential digital skills using Microsoft Office (Word, Excel, PowerPoint) and Gmail. This hands-on course, led by experienced instructors, empowers students to create documents,  design presentations, and set up email accounts, fostering IT literacy for academic and professional success.</p>
                <h2 class="font-orbitron text-primary text-lg mb-3">Program Overview</h2>
