            ...
            content: `
               <p class="mb-4">Join Ly Kun Media in Phnom Penh, Cambodia, for an intensive 7-day training program designed to equip you with essential skills in UI/UX design and frontend development. This hands-on course guides you through creating user-centric interfaces and building dynamic web applications, inspired by projects like the website, using tools like Figma, Adobe XD, HTML, CSS, JavaScript, React, and Vite.</p>
                ...
                <ul class="list-disc pl-5 mb-4">
                    ...
                    <li><strong>Day 5: Coding with HTML, CSS, JS, React, and Vite</strong>: Build a responsive frontend .</li>
                ...
                <p class="mb-4"><strong>Day 5: Coding with HTML, CSS, JS, React, and Vite</strong><br>Begin coding the frontend . Use HTML and CSS (with Tailwind CSS for rapid styling), JavaScript for interactivity, and React to create reusable components. Set up the project with Vite for optimized development and build a responsive interface for news browsing and user interaction.</p>
